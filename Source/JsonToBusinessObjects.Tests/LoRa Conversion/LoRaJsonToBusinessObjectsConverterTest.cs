...
namespace JsonToBusinessObjects.Tests.LoRa_Conversion
{
    public class LoRaJsonToBusinessObjectsConverterTest
    {
        ...
        [Fact]
        public void WhenGivenAValidNetmoreJson_ThenNoErrorsAreReported()
        {
            ConversionResult result = _testee.Convert(NetmoreDefaultMessage);
            result.BusinessObjectRoot.LoRaData.DeviceConnectionType.Should().Be(5);
            result.HasErrors.Should().BeFalse();
        }

        [Fact]
        public void WhenGivenAValidDigitaLegacyFormatJson_ThenNoErrorsAreReported()
        {
            ConversionResult result = _testee.Convert(DigitaLegacyFormat);
            result.BusinessObjectRoot.LoRaData.DeviceConnectionType.Should().Be(5);
            result.HasErrors.Should().BeFalse();
        }
        ...
        private const string DigitaLegacyFormat = "{\r\n     \"DevEUI_uplink\": {\r\n          \"Time\": \"2025-02-25T09:09:44.725Z\",\r\n          \"DevEUI\": \"XXXXXXXXXXXXXXXX\",\r\n          \"FPort\": \"5\",\r\n          \"FCntUp\": 7839,\r\n          \"ADRbit\": \"1\",\r\n          \"MType\": \"2\",\r\n          \"payload_hex\": \"010501d37fc000007fc000007fc000003f76c8b441bb33333920ac08\",\r\n          \"LrrRSSI\": \"-63\",\r\n          \"LrrSNR\": \"9.5\",\r\n          \"LrrESP\": \"-63.46\",\r\n          \"SpFact\": \"7\",\r\n          \"DevLrrCnt\": 1,\r\n          \"Lrrid\": \"7076FF0064053525\",\r\n          \"Late\": 0,\r\n          \"Lrrs\": {\r\n               \"Lrr\": [\r\n                    {\r\n                         \"Lrrid\": \"7076FF0064053525\",\r\n                         \"LrrRSSI\": \"-63\",\r\n                         \"LrrSNR\": \"9.5\",\r\n                         \"LrrESP\": \"-63.46\"\r\n                   }\r\n               ]\r\n          },\r\n          \"DeviceGroupID\": \"cd5f86afd887411e9dca6ff902e83b5d-dg\",\r\n          \"ParentID\": \"d84382c5598e420f9a1a21bc3506aea2-cu\",\r\n          \"CustomerID\": \"ee75fd19a6974f40a1b37983813620d9-cu\",\r\n          \"CustomerData\": {\r\n               \"alr\": {\r\n                    \"pro\": \"ERS_LITE\",\r\n                    \"name\": \"Testisensori (Elsys ERS Lite)\",\r\n                    \"serialNumber\": \"1234567890\"\r\n               }\r\n          },\r\n          \"Frequency\": 867700000,\r\n          \"DynamicClass\": \"CLASS_A\",\r\n          \"DevAddr\": \"E00496C4\"\r\n     }\r\n}";
        private const string NetmoreDefaultMessage = "{\r\n    \"devEui\": \"70b3d52a1ff00001\",\r\n    \"sensorType\": \"other\",\r\n    \"messageType\": \"payload\",\r\n    \"timestamp\": \"2023-03-31T08:00:08.599602Z\",\r\n    \"payload\": \"010501d37fc000007fc000007fc000003f76c8b441bb33333920ac08\",\r\n    \"fCntUp\": 15800,\r\n    \"toa\": null,\r\n    \"freq\": 868300000,\r\n    \"batteryLevel\": \"255\",\r\n    \"ack\": false,\r\n    \"spreadingFactor\": \"7\",\r\n    \"dr\": 5,\r\n    \"rssi\": \"-73\",\r\n    \"snr\": \"9.8\",\r\n    \"gatewayIdentifier\": \"506\",\r\n    \"fPort\": \"1\",\r\n    \"latitude\": 59.776931,\r\n    \"longitude\": 14.903832,\r\n    \"tags\": {\r\n      \"building\": [\r\n        \"A\"\r\n      ],\r\n      \"type\": [\r\n        \"MOTION\",\r\n        \"TEMP\"\r\n      ]\r\n    },\r\n    \"gateways\": [\r\n      {\r\n        \"rssi\": \"-73\",\r\n        \"snr\": \"9.8\",\r\n        \"gatewayIdentifier\": \"506\",\r\n        \"gwEui\": \"7276FF0039040879\",\r\n        \"mac\": \"7076FF02123C\",\r\n        \"antenna\": 0\r\n      },\r\n      {\r\n        \"rssi\": \"-47\",\r\n        \"snr\": \"9.5\",\r\n        \"gatewayIdentifier\": \"1789\",\r\n        \"gwEui\": \"647FDAFFFE016C40\",\r\n        \"mac\": \"647FDA016C40\",\r\n        \"antenna\": 0\r\n      }\r\n    ]\r\n  }";
    }
}